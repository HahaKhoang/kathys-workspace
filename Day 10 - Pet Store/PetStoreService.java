...
public class PetStoreService {
    ...
    // Vs.
    // A set of pets, would allow us to store unique values for pets (no duplicates), which do not have indexes,
    ...
    //I want to be able to print my pets, and I can do that by attempting to print the List Object
